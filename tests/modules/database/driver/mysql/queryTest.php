...
require_once(dirname(__FILE__).'/../../../../../modules/database/classes/database/query.php');
require_once(dirname(__FILE__).'/../../../../../modules/database/classes/driver/pdo/query.php');
require_once(dirname(__FILE__).'/../../../../../modules/database/classes/driver/mysql/query.php');
require_once(dirname(__FILE__).'/../../../../../modules/database/classes/database/expression.php');
...
class Query_Mysql_DriverTest extends PHPUnit_Framework_TestCase
{
	...
	public function testQuerySelect1()
	{
		$query = $this->object
			...
			->order_by('id', 'desc')
			->group_by('id')
			->having('j', '<', new Expression_Database('korova'))
