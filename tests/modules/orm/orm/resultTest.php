...
require_once(dirname(__FILE__).'/../files/test_orm.php');
...
class Result_ORMTest extends PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->object = new Result_ORM('Test_Orm',$this->stub);
    }
	...
	public function test_with(){
		...
		$this->object = new Result_ORM('Test_Orm', $this->stub, array(
				'tester' => array('model' => new Test_Orm), 
				'tester.another' => array('model' => new Test_Orm)
			));
