...
require_once('/files/test_orm.php');
/**
...
class ORMTest extends PHPUnit_Framework_TestCase
{
    ...
    {
		$this->assertEquals(false,$this->object->loaded());
        $this->object->values(array(), true);
		$this->assertEquals(true,$this->object->loaded());
    }
    ...
    {
        $this->object->limit(5);
		$this->assertEquals(5,$this->object->query()->limit());
    }
