...
require_once(dirname(__FILE__).'/../../../modules/orm/classes/orm.php');
require_once(dirname(__FILE__).'/files/tree_orm.php');
require_once(dirname(__FILE__).'/files/fairy_orm.php');
